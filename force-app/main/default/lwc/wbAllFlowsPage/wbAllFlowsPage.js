...
import previewIconImg from '@salesforce/resourceUrl/previewIcon';
import trashIconImg from '@salesforce/resourceUrl/trashIcon';
...
export default class WbAllFlowsPage extends LightningElement {
    ...
    previewIconUrl = previewIconImg;
    trashIconUrl = trashIconImg;
    @track allRecords = [];
