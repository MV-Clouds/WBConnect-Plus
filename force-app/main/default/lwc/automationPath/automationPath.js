...
export default class AutomationPath extends LightningElement {
            ...
            .then(result => {
                if (result) {
                    this.automation = {
                        ...
                        templateId: result.Template__c || '',
                        templateName: result.Template__r?.Template_Name__c || '',
    ...
    get whatsappButtonVariant() {
        return this.selectedAction === 'whatsapp' ? 'custom-button' : 'neutral';
    }

    get emailButtonVariant() {
        return this.selectedAction === 'email' ? 'custom-button' : 'neutral';
    }

    get createButtonVariant() {
        return this.selectedAction === 'create' ? 'custom-button' : 'neutral';
    }
