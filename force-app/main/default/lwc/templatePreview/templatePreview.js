    ...
    fetchInitialData(){
        ...
        try {
            ...
            .then((templateData) => {
                ...
                const doc = parser.parseFromString(this.templateData?.Header_Body__c, "text/html");
                ...
                const buttonBody = this.templateData.Button_Body__c ? JSON.parse(this.templateData.Button_Body__c) : []
            ...
            .then(chat => {
                if(chat){
                    ...
                    const templatePayload = this.createJSONBody(this.mobileNumber, "template", {
                        ...
                        headerImageURL: this.templateData?.Header_Body__c,
